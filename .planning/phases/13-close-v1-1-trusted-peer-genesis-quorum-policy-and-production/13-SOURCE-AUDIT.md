...
|---|---|---|---|---|---|
| GOAL | — | Authenticated genesis, persisted policy authority, production candidate operations, rollback-safe restart, and node-scoped live economics | 01-11 | COVERED | Roadmap goal and six success criteria map across the complete plan set. |
...
| REQ | TEST-01 | Tamper, startup, restart, production-network genesis, race, live burn, account-switch E2E | 02, 04-09, 11 | COVERED | All validation-contract targets included. |
...
| RESEARCH | R-09 | No new dependency/package | 01-11 | COVERED | Every threat model records no install. |
