...
- [x] 14-05-PLAN.md — Final manager caller migration, compatibility removal, and exact public-surface closure

**Wave 6** *(blocked on Wave 5 completion)*

- [x] 14-06-PLAN.md — Production/startup GeniusNode caller migration

**Wave 7** *(blocked on Wave 6 completion)*

- [x] 14-07-PLAN.md — Account and blockchain fixture GeniusNode caller migration
...
- [x] 14-09-PLAN.md — Multi-account GeniusNode caller migration

**Wave 10** *(blocked on Wave 9 completion)*

- [x] 14-10-PLAN.md — Bridge common/E2E GeniusNode caller migration

**Wave 11** *(blocked on Wave 10 completion)*

- [x] 14-11-PLAN.md — Bridge-race GeniusNode caller migration and shared-fixture target expansion
