...
namespace sgns::blockchain
{
   ...
   */
     ...
     */
        virtual outcome::result<void> addBlockBody( primitives::BlockNumber      block_number,
     ...
     */
        virtual outcome::result<void> finalize( const primitives::BlockHash     &block,
     ...
     */
        virtual BlockHashVecRes getChainByBlocks( const primitives::BlockHash &top_block,
