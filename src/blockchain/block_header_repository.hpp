...
namespace sgns::blockchain
{
   ...
   */
     ...
     */
        auto getNumberById( const primitives::BlockId &id ) const -> outcome::result<primitives::BlockNumber>;
     ...
     * is not in storage or a storage error
     */
        auto getHashById( const primitives::BlockId &id ) const -> outcome::result<base::Hash256>;
    };
}
