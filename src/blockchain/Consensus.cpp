...
namespace sgns
{
                                                ...
                                                const std::string                     &cid )
    {
        ...
        pending.set_proposal_id( certificate.proposal_id() );
        pending.set_winner_id( subject_hash.value() );
        ...
        if ( !stored_process || !stored_process.value() ) return;
        {
        ...
        }
        {
            ...
            if ( process && process.value() ) restored_processes_[slot_id] = process.value().value();
        }
