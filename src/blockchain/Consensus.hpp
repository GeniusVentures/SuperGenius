...
namespace sgns
{
    ...
    private:
        ...
        bool certificate_delta_filter_registered_ = false; ///< Owns the CRDT certificate delta filter.
        bool certificate_filter_registered_       = false; ///< Owns the CRDT certificate element filter.
