...
namespace sgns::blockchain
{
   ...
   */
    ...
    public:
        ...
        virtual outcome::result<void> putBlockData( primitives::BlockNumber,
        ...
        virtual outcome::result<void> putJustification( const primitives::Justification &j,
                                                        const primitives::BlockHash     &hash,
                                                        const primitives::BlockNumber   &number ) = 0;

        virtual outcome::result<void> removeBlock( const primitives::BlockHash   &hash,
                                                   const primitives::BlockNumber &number ) = 0;
    };
