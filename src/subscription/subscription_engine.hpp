#ifndef SUPERGENIUS_SUBSCRIPTION_ENGINE_HPP
#define SUPERGENIUS_SUBSCRIPTION_ENGINE_HPP
...
namespace sgns::subscription
{
    ...
    template <typename Key, typename Type, typename... Arguments>
    class SubscriptionEngine final : public std::enable_shared_from_this<SubscriptionEngine<Key, Type, Arguments...>>
    {
    public:
        using KeyType        = Key;
    ...
    public:
        ...
        void notify( const KeyType &key, const Arguments &...args )
        {
            ...
            for ( auto it_sub = subscribers_container.begin(); it_sub != subscribers_container.end(); )
            {
...
#endif // SUPERGENIUS_SUBSCRIPTION_ENGINE_HPP
