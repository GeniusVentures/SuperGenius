...
#ifndef SUPERGENIUS_PROTOBUF_MESSAGE_READ_WRITER_HPP
#define SUPERGENIUS_PROTOBUF_MESSAGE_READ_WRITER_HPP
...
#endif  // SUPERGENIUS_PROTOBUF_MESSAGE_READ_WRITER_HPP
