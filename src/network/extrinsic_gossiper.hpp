...
#ifndef SUPERGENIUS_CORE_NETWORK_EXTRINSIC_GOSSIPER_HPP
#define SUPERGENIUS_CORE_NETWORK_EXTRINSIC_GOSSIPER_HPP
...
#endif  // SUPERGENIUS_CORE_NETWORK_EXTRINSIC_GOSSIPER_HPP
