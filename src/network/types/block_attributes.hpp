...
#ifndef SUPERGENIUS_SRC_NETWORK_TYPES_BLOCK_ATTRIBUTES_HPP
#define SUPERGENIUS_SRC_NETWORK_TYPES_BLOCK_ATTRIBUTES_HPP
...
#endif  // SUPERGENIUS_SRC_NETWORK_TYPES_BLOCK_ATTRIBUTES_HPP
