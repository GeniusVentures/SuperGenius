...
#ifndef SUPERGENIUS_VERIFICATION_PRODUCTION_OBSERVER_HPP
#define SUPERGENIUS_VERIFICATION_PRODUCTION_OBSERVER_HPP
...
#endif  // SUPERGENIUS_VERIFICATION_PRODUCTION_OBSERVER_HPP
