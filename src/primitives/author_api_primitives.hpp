...
#ifndef SUPERGENIUS_CORE_PRIMITIVES_EXTRINSIC_API_PRIMITIVES_HPP
#define SUPERGENIUS_CORE_PRIMITIVES_EXTRINSIC_API_PRIMITIVES_HPP
...
#endif  //SUPERGENIUS_CORE_PRIMITIVES_EXTRINSIC_API_PRIMITIVES_HPP
