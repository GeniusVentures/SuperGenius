     ...
     */
        ...
        bool operator==( const Version &rhs ) const
        {
            return spec_name == rhs.spec_name && impl_name == rhs.impl_name &&
                   authoring_version == rhs.authoring_version && impl_version == rhs.impl_version && apis == rhs.apis &&
        ...
        {
            return out << v.spec_name << v.impl_name << v.authoring_version << v.spec_version << v.impl_version
                       << v.apis.size();
        }
