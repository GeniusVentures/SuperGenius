...
namespace sgns::primitives
{
   ...
   */
     ...
     */
        boost::optional<primitives::Block> toBlock() const
        {
            ...
            return body ? primitives::Block{ *header, *body } : primitives::Block{ *header };
        }
    };
   ...
   */
    ...
    {
        return lhs.hash == rhs.hash && lhs.header == rhs.header && lhs.body == rhs.body && lhs.receipt == rhs.receipt &&
               lhs.message_queue == rhs.message_queue && lhs.justification == rhs.justification;
    }
