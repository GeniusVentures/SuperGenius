...
#ifndef SUPERGENIUS_CORE_PRIMITIVES_APPLY_RESULT_HPP
#define SUPERGENIUS_CORE_PRIMITIVES_APPLY_RESULT_HPP
...
#endif  // SUPERGENIUS_CORE_PRIMITIVES_APPLY_RESULT_HPP
