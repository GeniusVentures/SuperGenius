...
namespace sgns::primitives
{
    ...
    inline const auto kProductionEngineId = VerificationEngineId::fromString( "BABE" ).value();

    inline const auto kFinalityEngineId = VerificationEngineId::fromString( "FRNK" ).value();
    ...
    namespace detail
    {
        struct DigestItemCommon
        {
            ...
            {
                return verification_engine_id == rhs.verification_engine_id && data == rhs.data;
            }
    ...
    struct Verification : public detail::DigestItemCommon
    {
        ...
        template <class A, typename = std::enable_if_t<!std::is_same_v<A, Verification>, void>>
