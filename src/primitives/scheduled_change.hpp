...
#ifndef SUPERGENIUS_CORE_PRIMITIVES_SCHEDULED_CHANGE_HPP
#define SUPERGENIUS_CORE_PRIMITIVES_SCHEDULED_CHANGE_HPP
...
#endif  // SUPERGENIUS_CORE_PRIMITIVES_SCHEDULED_CHANGE_HPP
