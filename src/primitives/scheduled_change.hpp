...
#ifndef SUPERGENIUS_SRC_PRIMITIVES_SCHEDULED_CHANGE_HPP
#define SUPERGENIUS_SRC_PRIMITIVES_SCHEDULED_CHANGE_HPP
...
#endif  // SUPERGENIUS_SRC_PRIMITIVES_SCHEDULED_CHANGE_HPP
