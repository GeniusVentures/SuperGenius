...
namespace sgns
{
    ...
    public:
        ...
        outcome::result<std::optional<ConsensusStateStore::BurnOutpoint>> DescribeConsensusResource(
            const ConsensusManager::Subject &subject, const std::string &slot_id ) const;
