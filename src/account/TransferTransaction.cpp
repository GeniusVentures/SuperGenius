...
namespace sgns
{
    ...
    const std::vector<TransferTransaction::OutputDestInfo> TransferTransaction::GetDstInfos() const
    {
        return outputs_;
    }
    const std::vector<TransferTransaction::InputUTXOInfo> TransferTransaction::GetInputInfos() const
    {
        return input_tx_;
    }
