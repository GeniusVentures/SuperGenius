...
namespace sgns
{
    ...
    private:
        ...
        static constexpr std::string_view PROCESSING_GRID_CHANNEL = "SGNUS.Jobs.1a.05";
        static constexpr std::string_view PROCESSING_CHANNEL      = "SGNUS.TestNet.Channel.1a.05";
