...
namespace sgns::evmwatcher
{
    ...
    EvmMessagingWatcher::EvmMessagingWatcher( const rapidjson::Document      &config,
                                              MessageCallback                 callback,
                                              const std::string              &contract_address,
                                              const std::vector<TopicFilter> &topic_filters ) :
        MessagingWatcher( std::move( callback ) ), contract_address( contract_address ), topic_filters( topic_filters )
    {
