...
namespace sgns::verification {
  ProductionSynchronizerImpl::ProductionSynchronizerImpl(
      std::shared_ptr<network::SyncClientsSet> sync_clients)
      : sync_clients_{std::move(sync_clients)},
        logger_{base::createLogger("ProductionSynchronizer")} {
  ...
  void ProductionSynchronizerImpl::request(const primitives::BlockId &from,
  ...
  ProductionSynchronizerImpl::selectNextClient(
  ...
  void ProductionSynchronizerImpl::pollClients(
