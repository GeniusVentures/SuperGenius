#ifndef SUPERGENIUS_AUTHORITY_MANAGER
...
namespace sgns::authority {
  class AuthorityManager : public IComponent {
   public:
     ...
     * blocks, after next one would be finalized by the finality verification
     * engine
     ...
     * and casting FINALITY votes for finalization. Similarly, other nodes should
     ...
     * is a block finalized by the finality verification engine. After finalizing
     ...
     * Verification engine. After authoring the block B 0 , the authorities should
     * resume voting.
     * @param block is info of block which representing this change
     * @param activateAt is number of block when changes will applied
     */
...
#endif  // SUPERGENIUS_AUTHORITY_MANAGER
