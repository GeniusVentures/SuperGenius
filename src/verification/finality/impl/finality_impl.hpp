...
#ifndef SUPERGENIUS_SRC_VERIFICATION_FINALITY_IMPL_GRANDPAIMPL
#define SUPERGENIUS_SRC_VERIFICATION_FINALITY_IMPL_GRANDPAIMPL
...
#endif  // SUPERGENIUS_SRC_VERIFICATION_FINALITY_IMPL_GRANDPAIMPL
