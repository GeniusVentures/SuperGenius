...
#ifndef SUPERGENIUS_CORE_SCALE_SCALE_DECODER_STREAM_HPP
#define SUPERGENIUS_CORE_SCALE_SCALE_DECODER_STREAM_HPP
...
#endif  // SUPERGENIUS_CORE_SCALE_SCALE_DECODER_STREAM_HPP
