...
namespace sgns::storage::changes_trie
{
   ...
   */
    ...
    {
    public:
        using GetExtrinsicIndexDelegate = std::function<outcome::result<base::Buffer>()>;
     ...
     */
        virtual outcome::result<void> onBlockChange( primitives::BlockHash   new_parent_hash,
     ...
     */
        virtual outcome::result<base::Hash256> constructChangesTrie( const primitives::BlockHash &parent,
