...
namespace sgns::storage::changes_trie
{
    ...
    {
    public:
        using ExtrinsicsChanges = std::map<base::Buffer, std::vector<primitives::ExtrinsicIndex>>;
    ...
    private:
        ChangesTrie( std::unique_ptr<trie::SuperGeniusTrie> trie, std::shared_ptr<trie::Codec> codec );
     ...
     */
        ...
        using KeyIndexVariant =
            boost::variant<Unused<0> /*uint32_t*/, ExtrinsicsChangesKey, BlocksChangesKey, ChildChangesKey>;
