...
namespace sgns::storage::changes_trie
{
    ...
    class StorageChangesTrackerImpl : public ChangesTracker
    {
        ...
        using SubscriptionEngineType =
            subscription::SubscriptionEngine<base::Buffer, SessionPtr, base::Buffer, primitives::BlockHash>;
    ...
    public:
        ...
        StorageChangesTrackerImpl( std::shared_ptr<storage::trie::SuperGeniusTrieFactory> trie_factory,
     ...
     */
        ...
        outcome::result<void> onBlockChange( primitives::BlockHash   new_parent_hash,
                                             primitives::BlockNumber new_parent_number ) override;

        outcome::result<void> onPut( const base::Buffer &key, const base::Buffer &value, bool new_entry ) override;
        outcome::result<void> onRemove( const base::Buffer &key ) override;

        outcome::result<base::Hash256> constructChangesTrie( const primitives::BlockHash &parent,
    ...
    private:
        ...
        std::map<base::Buffer, std::vector<primitives::ExtrinsicIndex>> extrinsics_changes_;
