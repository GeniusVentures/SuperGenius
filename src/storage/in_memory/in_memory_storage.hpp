...
namespace sgns::storage
{
   ...
   */
    ...
    public:
        ...
        std::unique_ptr<sgns::storage::face::WriteBatch<base::Buffer, base::Buffer>> batch() override;

        std::unique_ptr<sgns::storage::face::MapCursor<base::Buffer, base::Buffer>> cursor() override;
