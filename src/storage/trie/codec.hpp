...
namespace sgns::storage::trie
{
   ...
   */
     ...
     */
        virtual outcome::result<base::Buffer> encodeNode( const Node &node ) const = 0;
     ...
     */
        virtual outcome::result<std::shared_ptr<Node>> decodeNode( const base::Buffer &encoded_data ) const = 0;
