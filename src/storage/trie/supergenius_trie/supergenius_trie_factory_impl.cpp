...
namespace sgns::storage::trie
{
    ...
    std::unique_ptr<SuperGeniusTrie> SuperGeniusTrieFactoryImpl::createEmpty( ChildRetrieveFunctor f ) const
    {
        return std::make_unique<SuperGeniusTrieImpl>( f );
    }

    std::unique_ptr<SuperGeniusTrie> SuperGeniusTrieFactoryImpl::createFromRoot( SuperGeniusTrie::NodePtr root,
