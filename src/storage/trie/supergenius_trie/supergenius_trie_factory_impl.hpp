...
namespace sgns::storage::trie
{
    ...
    {
    public:
        std::unique_ptr<SuperGeniusTrie> createEmpty( ChildRetrieveFunctor f ) const override;
        std::unique_ptr<SuperGeniusTrie> createFromRoot( SuperGeniusTrie::NodePtr root,
