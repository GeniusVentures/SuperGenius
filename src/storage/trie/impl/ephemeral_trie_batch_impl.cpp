...
namespace sgns::storage::trie
{
    ...
    EphemeralTrieBatchImpl::EphemeralTrieBatchImpl( std::shared_ptr<Codec>           codec,
    ...
    outcome::result<void> EphemeralTrieBatchImpl::clearPrefix( const Buffer &prefix )
    {
        return trie_->clearPrefix( prefix );
    }

    outcome::result<void> EphemeralTrieBatchImpl::put( const Buffer &key, const Buffer &value )
    {
        return trie_->put( key, value );
    }

    outcome::result<void> EphemeralTrieBatchImpl::put( const Buffer &key, Buffer &&value )
    {
