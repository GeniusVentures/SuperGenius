...
namespace sgns::storage::trie
{
   ...
   */
    class TrieStorageBackendBatch : public face::WriteBatch<base::Buffer, base::Buffer>
    {
    public:
        TrieStorageBackendBatch( std::unique_ptr<face::WriteBatch<base::Buffer, base::Buffer>> storage_batch,
    ...
    private:
        ...
        std::unique_ptr<face::WriteBatch<base::Buffer, base::Buffer>> storage_batch_;
