...
namespace sgns::verification::finality
{
    ...
    public:
        ...
        MOCK_METHOD2( insert, outcome::result<void>( const BlockInfo &block, const VoteWeight &vote ) );

        MOCK_METHOD2( insert, outcome::result<void>( const Prevote &prevote, const VoteWeight &vote ) );

        MOCK_METHOD2( insert, outcome::result<void>( const Precommit &precommit, const VoteWeight &vote ) );

        MOCK_METHOD2( findAncestor, boost::optional<BlockInfo>( const BlockInfo &, const Condition & ) );
