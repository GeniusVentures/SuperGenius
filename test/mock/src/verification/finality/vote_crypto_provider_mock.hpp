...
namespace sgns::verification::finality
{
    ...
    {
    public:
        MOCK_CONST_METHOD1( verifyPrimaryPropose, bool( const SignedMessage &primary_propose ) );
        ...
        MOCK_CONST_METHOD1( signPrimaryPropose, SignedMessage( const PrimaryPropose &primary_propose ) );
