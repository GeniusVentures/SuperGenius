...
#ifndef SUPERGENIUS_TEST_SRC_RUNTIME_MOCK_EXTENSION_HPP_
#define SUPERGENIUS_TEST_SRC_RUNTIME_MOCK_EXTENSION_HPP_
...
namespace sgns::extensions
{
    ...
    public:
        ...
        MOCK_METHOD2( ext_clear_prefix, void( runtime::WasmPointer prefix_data, runtime::WasmSize prefix_length ) );
        MOCK_METHOD2( ext_clear_storage, void( runtime::WasmPointer key_data, runtime::WasmSize key_length ) );
        MOCK_CONST_METHOD2( ext_exists_storage,
                            runtime::WasmSize( runtime::WasmPointer key_data, runtime::WasmSize key_length ) );
        ...
        MOCK_METHOD2( ext_storage_changes_root,
                      runtime::WasmSize( runtime::WasmPointer parent_hash_data, runtime::WasmPointer result ) );
        ...
        MOCK_METHOD2( ext_print_hex, void( runtime::WasmPointer data, runtime::WasmSize length ) );
        MOCK_METHOD3( ext_logging_log_version_1,
                      void( runtime::WasmEnum level, runtime::WasmSpan target, runtime::WasmSpan message ) );
        MOCK_METHOD1( ext_print_num, void( uint64_t value ) );
        MOCK_METHOD2( ext_print_utf8, void( runtime::WasmPointer utf8_data, runtime::WasmSize utf8_length ) );
        MOCK_METHOD3( ext_blake2_128,
                      void( runtime::WasmPointer data, runtime::WasmSize len, runtime::WasmPointer out ) );
        MOCK_METHOD3( ext_blake2_256,
                      void( runtime::WasmPointer data, runtime::WasmSize len, runtime::WasmPointer out ) );
        MOCK_METHOD3( ext_keccak_256,
                      void( runtime::WasmPointer data, runtime::WasmSize len, runtime::WasmPointer out ) );
        MOCK_METHOD2( ext_ed25519_public_keys,
                      runtime::WasmSize( runtime::WasmSize key_type, runtime::WasmPointer out_ptr ) );
        ...
        MOCK_METHOD2( ext_sr25519_public_keys,
                      runtime::WasmSize( runtime::WasmSize key_type, runtime::WasmPointer out_keys ) );
        ...
        MOCK_METHOD4( ext_sr25519_verify,
                      runtime::WasmSize( runtime::WasmPointer msg_data,
                                         ...
                                         runtime::WasmPointer sig_data,
                                         runtime::WasmPointer pubkey_data ) );
        MOCK_METHOD3( ext_twox_64, void( runtime::WasmPointer data, runtime::WasmSize len, runtime::WasmPointer out ) );
        ...
        MOCK_METHOD2( ext_storage_set_version_1, void( runtime::WasmSpan, runtime::WasmSpan ) );

        MOCK_METHOD1( ext_storage_get_version_1, runtime::WasmSpan( runtime::WasmSpan ) );

        MOCK_METHOD1( ext_storage_clear_version_1, void( runtime::WasmSpan ) );

        MOCK_CONST_METHOD1( ext_storage_exists_version_1, runtime::WasmSize( runtime::WasmSpan ) );
        ...
        MOCK_METHOD1( ext_storage_changes_root_version_1, runtime::WasmSpan( runtime::WasmSpan ) );

        MOCK_CONST_METHOD1( ext_storage_next_key_version_1, runtime::WasmSpan( runtime::WasmSpan ) );

        MOCK_METHOD1( ext_trie_blake2_256_root_version_1, runtime::WasmPointer( runtime::WasmSpan values_data ) );

        MOCK_METHOD1( ext_trie_blake2_256_ordered_root_version_1, runtime::WasmPointer( runtime::WasmSpan ) );

        // -------------------- hashing methods v1 --------------------

        MOCK_METHOD1( ext_hashing_keccak_256_version_1, runtime::WasmPointer( runtime::WasmSpan ) );

        MOCK_METHOD1( ext_hashing_sha2_256_version_1, runtime::WasmPointer( runtime::WasmSpan ) );

        MOCK_METHOD1( ext_hashing_blake2_128_version_1, runtime::WasmPointer( runtime::WasmSpan ) );

        MOCK_METHOD1( ext_hashing_blake2_256_version_1, runtime::WasmPointer( runtime::WasmSpan ) );

        MOCK_METHOD1( ext_hashing_twox_64_version_1, runtime::WasmPointer( runtime::WasmSpan ) );

        MOCK_METHOD1( ext_hashing_twox_128_version_1, runtime::WasmPointer( runtime::WasmSpan ) );

        MOCK_METHOD1( ext_hashing_twox_256_version_1, runtime::WasmPointer( runtime::WasmSpan ) );

        // -------------------------Crypto extensions v1---------------------

        MOCK_METHOD1( ext_ed25519_public_keys_v1, runtime::WasmSpan( runtime::WasmSize key_type ) );

        MOCK_METHOD2( ext_ed25519_generate_v1,
                      runtime::WasmPointer( runtime::WasmSize key_type, runtime::WasmSpan seed ) );
        ...
        MOCK_METHOD1( ext_sr25519_public_keys_v1, runtime::WasmSpan( runtime::WasmSize key_type ) );
        ...
        MOCK_METHOD2( ext_crypto_secp256k1_ecdsa_recover_v1,
                      runtime::WasmSpan( runtime::WasmPointer sig, runtime::WasmPointer msg ) );
        ...
        MOCK_METHOD1( ext_allocator_malloc_version_1, runtime::WasmPointer( runtime::WasmSize ) );
