...
namespace sgns::crdt
{
    ...
    protected:
        ...
        void SetUp() override
        {
            ...
            crdtDatastore_ = CrdtDatastore::New( dataStore,
                                                 namespaceKey,
                                                 dagSyncer,
                                                 broadcaster,
    ...
    TEST_F( AtomicTransactionTest, TestAtomicUpdates )
    {
        ...
        for ( bool use_atomic : { false, true } )
        {
            ...
            std::thread t1(
                [&]()
                {
                    ConcurrentWriter( key1, key2, transfer_from_value, transfer_to_value, use_atomic, did_interrupt );
                    t1_finished = true;
                } );
            ...
            {
                bool has_interference = value1.toString() != "50" || value2.toString() != "150";
