...
TEST( MessagingWatcherTest, EvmMessagingWatcherInitialization )
{
    ...
    std::vector<EvmMessagingWatcher::TopicFilter> topicFilters = { { std::string( sgns::kBridgeSourceBurnedSig ) } };
...
TEST( MessagingWatcherTest, MultipleWatchersManagement )
{
    ...
    std::vector<EvmMessagingWatcher::TopicFilter> topicFilters1 = { { std::string( sgns::kBridgeSourceBurnedSig ) } };
    std::vector<EvmMessagingWatcher::TopicFilter> topicFilters2 = { { "AnotherEvent(address,uint256)" } };
