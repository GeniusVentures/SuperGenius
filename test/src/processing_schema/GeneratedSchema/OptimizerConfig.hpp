...
namespace sgns {
    ...
    class OptimizerConfig {
        ...
        OptimizerConfigProperties properties;
        ...
        const OptimizerConfigProperties & get_properties() const { return properties; }
        OptimizerConfigProperties & get_mutable_properties() { return properties; }
        void set_properties(const OptimizerConfigProperties & value) { this->properties = value; }
    };
}
