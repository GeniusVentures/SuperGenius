...
using sgns::primitives::InvalidTransaction;
using sgns::primitives::PreRuntime;
using sgns::primitives::TransactionValidity;
using sgns::primitives::UnknownTransaction;
using sgns::primitives::ValidTransaction;
using sgns::primitives::Version;
...
class Primitives : public testing::Test
{
    void SetUp() override
    {
        block_id_hash_ = Hash256::fromHex( "000102030405060708090A0B0C0D0E0F"
...
{
    std::string encoded_str = { '\b', 't',  'e',  's',    't',  'i',  'n',  'h',    '0',  '4',  '\f', '\x01',
                                '\0', '\0', '\0', '\x02', '\0', '\0', '\0', '\x03', '\0', '\0', '\0', 't',
                                'e',  's',  't',  'i',    'n',  'h',  '1',  '\x10', '\a', '\0', '\0', '\0' };
