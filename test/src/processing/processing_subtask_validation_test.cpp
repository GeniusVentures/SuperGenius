...
// ═══════════════════════════════════════════════════════════════════════
// Phase 4: ValidateResultData — 9a scheme validation (via CompleteSubTask).
// CompleteSubTask calls ValidateResultData(result, false) — scheme only.
// ═══════════════════════════════════════════════════════════════════════

/**
 * @given A subtask with ipfs_results_data_id containing an ipfs:// CID.
 * @when CompleteSubTask is called.
 * @then The scheme check passes (9a only, no bitswap availability check).
 */
TEST_F( SubTaskValidationTest, ValidateResultData_9a_AcceptsIpfsScheme )
{
    auto                      pubs1 = m_pubsub_nodes[0];
    std::chrono::milliseconds resultTime;
    ...
    subTask->set_subtaskid( "VALIDATE_9A_OK" );
    subTask->set_ipfsblock( "test_ipfs_block" );
    subTask->set_json_data( "{}" );
    subTask->set_datalen( 1000 );
    auto chunk = subTask->add_chunkstoprocess();
    ...
    auto item = queue->mutable_processing_queue()->add_items();
    item->set_subtaskid( "VALIDATE_9A_OK" );
    ...
    SGProcessing::SubTaskResult result;
    result.set_subtaskid( "VALIDATE_9A_OK" );
    result.set_node_address( "test_node" );
    result.set_ipfs_results_data_id( "ipfs://QmTestCID123\nipfs://QmTestCID456" );
 ...
 */
TEST_F( SubTaskValidationTest, ValidateResultData_9a_RejectsFileScheme )
{
    auto                      pubs1 = m_pubsub_nodes[0];
    std::chrono::milliseconds resultTime;
    ...
    auto  subTask = queue->mutable_subtasks()->add_items();
    subTask->set_subtaskid( "VALIDATE_9A_FAIL" );
    subTask->set_ipfsblock( "test_ipfs_block" );
    subTask->set_json_data( "{}" );
    subTask->set_datalen( 1000 );
    auto chunk = subTask->add_chunkstoprocess();
    ...
    auto item = queue->mutable_processing_queue()->add_items();
    item->set_subtaskid( "VALIDATE_9A_FAIL" );
    ...
    SGProcessing::SubTaskResult result;
    result.set_subtaskid( "VALIDATE_9A_FAIL" );
    result.set_node_address( "test_node" );
    result.set_ipfs_results_data_id( "file:///tmp/output.raw" );  // wrong scheme
    result.add_chunk_hashes( "hash_invalid_scheme" );
 ...
 */
TEST_F( SubTaskValidationTest, ValidateResultData_EmptyDataIdPasses )
{
    auto                      pubs1 = m_pubsub_nodes[0];
    std::chrono::milliseconds resultTime;
    ...
    auto  subTask = queue->mutable_subtasks()->add_items();
    subTask->set_subtaskid( "VALIDATE_EMPTY" );
    subTask->set_ipfsblock( "test_ipfs_block" );
    subTask->set_json_data( "{}" );
    subTask->set_datalen( 1000 );
    auto chunk = subTask->add_chunkstoprocess();
    ...
    auto item = queue->mutable_processing_queue()->add_items();
    item->set_subtaskid( "VALIDATE_EMPTY" );
    ...
    SGProcessing::SubTaskResult result;
    result.set_subtaskid( "VALIDATE_EMPTY" );
    result.set_node_address( "test_node" );
    result.set_ipfs_results_data_id( "" );  // empty
    result.add_chunk_hashes( "hash_empty" );
