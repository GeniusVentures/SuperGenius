 ...
 // TODO (kamilsa): workaround unless we bump gtest version to 1.8.1+
   ...
   //std::ostream& operator<<(std::ostream& s,
   //  const sgns::primitives::BlockNumber& test_struct) {
   //  return s;
   //}
   std::ostream& operator<<(std::ostream& s,
   ...
   std::ostream& operator<<(std::ostream& s,
     const outcome::result<Digest>& test_struct) {
     return s;
   }
   std::ostream& operator<<(std::ostream& s,
     const outcome::result<InherentData>& test_struct) {
     return s;
   }
   std::ostream& operator<<(std::ostream& s,
     const outcome::result<InherentIdentifier>& test_struct) {
     return s;
   }
   std::ostream& operator<<(std::ostream& s,
     const outcome::result<Transaction>& test_struct) {
     return s;
   }
  ...
  public:
   ...
   void SetUp() override {
     ...
     EXPECT_CALL(*block_builder_factory_,
         ...
         .WillOnce(Return(testing::ByMove(std::unique_ptr<BlockBuilder>())));
