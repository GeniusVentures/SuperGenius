...
struct ED25519ProviderTest : public ::testing::Test
{
    void SetUp() override
    {
        ...
        hex_seed = "ccb4ec79974db3dae0d4dff7e0963db6b798684356dc517ff5c2e61f3b641569";
        hex_public_key =
...
TEST_F( ED25519ProviderTest, SignVerifySuccess )
{
    ...
    EXPECT_OUTCOME_TRUE( res, ed25519_provider->verify( signature, message_span, kp.public_key ) );
    ASSERT_EQ( res, true );
}
...
TEST_F( ED25519ProviderTest, VerifyWrongKeyFail )
{
    ...
    EXPECT_OUTCOME_TRUE( kp1, ed25519_provider->generateKeypair() );
    EXPECT_OUTCOME_TRUE( ver_res, ed25519_provider->verify( signature, message_span, kp1.public_key ) );
...
TEST_F( ED25519ProviderTest, DISABLED_VerifyInvalidKeyFail )
{
    ...
    kp.public_key.fill( 1 );
    EXPECT_OUTCOME_FALSE_1( ed25519_provider->verify( signature, message_span, kp.public_key ) );
}
