...
namespace vrf_constants = sgns::crypto::constants::sr25519::vrf;

struct ProductionLotteryTest : public testing::Test {
  void SetUp() override {
  ...
  ProductionLotteryImpl lottery_{vrf_provider_, hasher_};
...
/**
 * @given ProductionLottery with a number of VRF values submitted
