...
#define EXPECT_OUTCOME_TRUE_3( var, val, expr ) EXPECT_OUTCOME_TRUE_name( var, val, expr )

#define EXPECT_OUTCOME_TRUE_2( val, expr ) EXPECT_OUTCOME_TRUE_3( UNIQUE_NAME_( _r ), val, expr )

#define EXPECT_OUTCOME_TRUE_1( expr ) EXPECT_OUTCOME_TRUE_void( UNIQUE_NAME_( _v ), expr )

#define EXPECT_OUTCOME_FALSE_3( var, val, expr ) EXPECT_OUTCOME_FALSE_name( var, val, expr )

#define EXPECT_OUTCOME_FALSE_2( val, expr ) EXPECT_OUTCOME_FALSE_3( UNIQUE_NAME_( _r ), val, expr )

#define EXPECT_OUTCOME_FALSE_1( expr ) EXPECT_OUTCOME_FALSE_void( UNIQUE_NAME_( _v ), expr )
 ...
 */
#define EXPECT_OUTCOME_TRUE( val, expr ) EXPECT_OUTCOME_TRUE_name( UNIQUE_NAME_( _r ), val, expr )

#define EXPECT_OUTCOME_FALSE( val, expr ) EXPECT_OUTCOME_FALSE_name( UNIQUE_NAME_( _f ), val, expr )

#define EXPECT_OUTCOME_TRUE_MSG_void( var, expr, msg )                                                                 \
    auto &&var = expr;                                                                                                 \
    EXPECT_TRUE( var ) << "Line " << __LINE__ << ": " << var.error().message() << "\t" << ( msg );
 ...
 */
#define EXPECT_OUTCOME_TRUE_MSG_1( expr, msg ) EXPECT_OUTCOME_TRUE_MSG_void( UNIQUE_NAME_( _v ), expr, msg )
 ...
 * and appends custom error message specified in msg.
 */
#define EXPECT_OUTCOME_TRUE_MSG( val, expr, msg ) EXPECT_OUTCOME_TRUE_MSG_name( UNIQUE_NAME_( _r ), val, expr, msg )
...
#define EXPECT_OUTCOME_RAISE( ecode, statement ) EXPECT_OUTCOME_RAISE_3( UNIQUE_NAME_( _e ), ecode, statement )
...
#define EXPECT_OUTCOME_EQ( expr, value ) EXPECT_OUTCOME_EQ_3( UNIQUE_NAME_( _v ), expr, value )

#define _OUTCOME_UNIQUE_NAME_GLUE2( x, y ) x##y
#define _OUTCOME_UNIQUE_NAME_GLUE( x, y ) _OUTCOME_UNIQUE_NAME_GLUE2( x, y )
#define _OUTCOME_UNIQUE_NAME _OUTCOME_UNIQUE_NAME_GLUE( __outcome_result, __COUNTER__ )
...
#define ASSERT_OUTCOME_SOME_ERROR( _expression_ )                                                                      \
    {                                                                                                                  \
        ...
        if ( !result.has_error() )                                                                                     \
        {                                                                                                              \
            GTEST_FATAL_FAILURE_( "Outcome of: " #_expression_ ) << "  Actual:   Success\n"                            \
                                                                 << "Expected:   Some error";                          \
        }                                                                                                              \
    }
...
#define ASSERT_OUTCOME_ERROR( _expression_, _failure_ )                                                                \
    {                                                                                                                  \
        ...
        {                                                                                                              \
            GTEST_FATAL_FAILURE_( "Outcome of: " #_expression_ )                                                       \
                << "  Actual:   Success\n"                                                                             \
                << "Expected:   Error '" << outcome::result<void>( _failure_ ).error().message() << "'";               \
        }                                                                                                              \
    }
...
#define EXPECT_OUTCOME_SOME_ERROR( _result_, _expression_ )                                                            \
    ...
    if ( !_result_.has_error() )                                                                                       \
    {                                                                                                                  \
        GTEST_NONFATAL_FAILURE_( "Outcome of: " #_expression_ ) << "  Actual:   Success\n"                             \
                                                                << "Expected:   Some error";                           \
    }
...
#define EXPECT_OUTCOME_ERROR( _result_, _expression_, _error_ )                                                        \
    ...
    {                                                                                                                  \
        ...
        {                                                                                                              \
            GTEST_NONFATAL_FAILURE_( "Outcome of: " #_expression_ )                                                    \
                << "  Actual:   Error '" << _result_.error().message() << "'\n"                                        \
                << "Expected:   Error '" << outcome::result<void>( _error_ ).error().message() << "'";                 \
        }                                                                                                              \
    }                                                                                                                  \
    else                                                                                                               \
    {                                                                                                                  \
