...
#ifndef SUPERGENIUS_STD_LIST_ADAPTER_HPP
#define SUPERGENIUS_STD_LIST_ADAPTER_HPP
...
namespace test
{
    ...
    using sgns::face::ForwardIterator;
    using sgns::face::GenericIterator;
    using sgns::face::GenericList;
   ...
   */
    ...
    public:
        ...
        sgns::face::GenericIterator<GenericList<T>> &operator++() override
        {
            it_++;
            return *this;
        }
   ...
   */
    ...
    public:
        ...
        {
            auto &begin_it = dynamic_cast<StdListIterator<T> const &>( begin.get_iterator() );
            auto &end_it   = dynamic_cast<StdListIterator<T> const &>( end.get_iterator() );
