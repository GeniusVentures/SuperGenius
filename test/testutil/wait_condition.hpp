...
namespace sgns::test
{
    ...
    namespace Color
    {
        ...
        void ColoredPrint( const std::string &color, const std::string &prefix, const Args &...args )
        {
            ...
            {
                std::cout << color << prefix << Color::RESET << " " << message.str() << std::endl;
            }
            else
            {
...
#define ASSERT_WAIT_FOR_CONDITION( condition, timeout, description, actual_duration )                                  \
    sgns::test::assertWaitForCondition( condition,                                                                     \
                                        timeout,                                                                       \
                                        description,                                                                   \
                                        actual_duration,                                                               \
...
#define EXPECT_WAIT_FOR_CONDITION( condition, timeout, description, actual_duration )                                  \
    sgns::test::expectWaitForCondition( condition,                                                                     \
                                        timeout,                                                                       \
                                        description,                                                                   \
                                        actual_duration,                                                               \
                                        std::chrono::milliseconds( 10 ),                                               \
